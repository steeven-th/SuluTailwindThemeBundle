...
| `.iw-menu--scrolled` | Set by JS past the scroll threshold; a transparent navbar reverts to `--iw-menu-bg`. Override the scroll transition via `--iw-menu-scroll-duration` (default `300ms`). |
