...
> These variables are renamed to `--iw-menu-*` (kebab-case) in version `3.0.0` per the convention documented in [`css-conventions.md`](../css-conventions.md). The legacy names above will be updated alongside lot L3 of the 3.0.0 refactor.
